...
房产状态统计=basicURL+'/#/BasicInformationManage/HouseManage/ResourcesSummaryReport'
...
入住登记=basicURL+'/#/CustomerServiceManagement/CustomerCheckIn'
装修登记=basicURL+'/#/HouseDeliveryManage/DecorationRegistration'
#报事报修
...
及时率报表=basicURL+'/#/GTLJ/CustomerServiceManage/TimelinessReport'
...
#设备管理
设备类型=basicURL+'/#/DeviceManage/DeviceCategory'
设备档案=basicURL+'/#/DeviceManage/Devices'
保养计划=basicURL+'/#/DeviceManage/DeviceMaintenancePlan'
设备任务=basicURL+'/#/DeviceManage/DeviceMaintenanceTask'
设备巡查核查=basicURL+'/#/DeviceManage/DeviceMaintenanceCheck'
设备巡查问题=basicURL+'/#/DeviceManage/DeviceMaintenanceProblem'
#绿化管理
